            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        Update GalleryFolder
                    </header>
                    <div class="panel-body">
                        {foreach $galleryFolder as $key=>$item}
                        <form class="form-horizontal" id="default" enctype="multipart/form-data" action="index.php?controller=galleryFolder&action=update&id={$item['objectId']}" method="post">
