<script type="text/javascript">
    function answers()
    {
        ...
        frm.action = "index.php?controller=dayTitle&action=index&limit="+selectedanswer;
        frm.submit();
    }
</script>
<form id="frm" action="index.php?controller=dayTitle&action=index" method="post">
                        ...
                        <header class="panel-heading">
                            <div class="row">
                                <div class="col-xs-6 col-sm-6 placeholder">
                                    <h3 align="left"><span> DayTitle</span></h3>
                                </div>
                                ...
                                <div class=" col-xs-6 col-sm-2">
                                    <a class="btn btn-primary" href="index.php?controller=dayTitle&action=create">Create</a>
                        ...
                        <div class="panel-body">
                            <section id="unseen">
                                <table class="table table-bordered table-striped table-condensed">
                                    ...
                                    <tbody>
                                    {if isset($dayTitle)}
                                        {foreach $dayTitle as $key=>$item}
                                            <tr>
                                                <td>{$item['objectId']}</td>
                                                <td>{$item['Title']}</td>
                                                <td>{$item['TitleDate']}</td>
                                                <td>{$item['createAt']}
                                                </td>
                                                <td>{$item['updateAt']}</td>
                                                <td><a href="index.php?controller=dayTitle&action=update&id={$item['objectId']}" class="btn btn-success">Edit</a>
                                                    <span>|</span>
                                                    <a href="index.php?controller=dayTitle&action=delete&id={$item['objectId']}" class="btn btn-info">Delete</a>
                                                </td>
